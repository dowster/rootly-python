...
@_attrs_define
class NewAlertGroupDataAttributesTargetsItem:
    """
    Attributes:
        target_type (Union[Unset, NewAlertGroupDataAttributesTargetsItemTargetType]): The type of the target.
        target_id (Union[Unset, UUID]): id for the Group, Service or EscalationPolicy
    """

    target_type: Union[Unset, NewAlertGroupDataAttributesTargetsItemTargetType] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        target_type: Union[Unset, NewAlertGroupDataAttributesTargetsItemTargetType]
        if isinstance(_target_type, Unset):
            target_type = UNSET
        else:
            target_type = NewAlertGroupDataAttributesTargetsItemTargetType(_target_type)
        ...
        new_alert_group_data_attributes_targets_item = cls(
            target_type=target_type,
            target_id=target_id,
        )

        new_alert_group_data_attributes_targets_item.additional_properties = d
        return new_alert_group_data_attributes_targets_item
