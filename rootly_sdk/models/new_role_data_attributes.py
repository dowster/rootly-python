...
class NewRoleDataAttributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for alerts_permissions_item_data in _alerts_permissions or []:
            alerts_permissions_item = NewRoleDataAttributesAlertsPermissionsItem(alerts_permissions_item_data)
        ...
        for api_keys_permissions_item_data in _api_keys_permissions or []:
            api_keys_permissions_item = NewRoleDataAttributesApiKeysPermissionsItem(api_keys_permissions_item_data)
        ...
        for audits_permissions_item_data in _audits_permissions or []:
            audits_permissions_item = NewRoleDataAttributesAuditsPermissionsItem(audits_permissions_item_data)
        ...
        for billing_permissions_item_data in _billing_permissions or []:
            billing_permissions_item = NewRoleDataAttributesBillingPermissionsItem(billing_permissions_item_data)
        ...
        for environments_permissions_item_data in _environments_permissions or []:
            environments_permissions_item = NewRoleDataAttributesEnvironmentsPermissionsItem(
        ...
        for form_fields_permissions_item_data in _form_fields_permissions or []:
            form_fields_permissions_item = NewRoleDataAttributesFormFieldsPermissionsItem(
        ...
        for functionalities_permissions_item_data in _functionalities_permissions or []:
            functionalities_permissions_item = NewRoleDataAttributesFunctionalitiesPermissionsItem(
        ...
        for groups_permissions_item_data in _groups_permissions or []:
            groups_permissions_item = NewRoleDataAttributesGroupsPermissionsItem(groups_permissions_item_data)
        ...
        for incident_causes_permissions_item_data in _incident_causes_permissions or []:
            incident_causes_permissions_item = NewRoleDataAttributesIncidentCausesPermissionsItem(
        ...
        for incident_feedbacks_permissions_item_data in _incident_feedbacks_permissions or []:
            incident_feedbacks_permissions_item = NewRoleDataAttributesIncidentFeedbacksPermissionsItem(
        ...
        for incident_roles_permissions_item_data in _incident_roles_permissions or []:
            incident_roles_permissions_item = NewRoleDataAttributesIncidentRolesPermissionsItem(
        ...
        for incident_types_permissions_item_data in _incident_types_permissions or []:
            incident_types_permissions_item = NewRoleDataAttributesIncidentTypesPermissionsItem(
        ...
        for incidents_permissions_item_data in _incidents_permissions or []:
            incidents_permissions_item = NewRoleDataAttributesIncidentsPermissionsItem(incidents_permissions_item_data)
        ...
        for invitations_permissions_item_data in _invitations_permissions or []:
            invitations_permissions_item = NewRoleDataAttributesInvitationsPermissionsItem(
        ...
        for playbooks_permissions_item_data in _playbooks_permissions or []:
            playbooks_permissions_item = NewRoleDataAttributesPlaybooksPermissionsItem(playbooks_permissions_item_data)
        ...
        for private_incidents_permissions_item_data in _private_incidents_permissions or []:
            private_incidents_permissions_item = NewRoleDataAttributesPrivateIncidentsPermissionsItem(
        ...
        for pulses_permissions_item_data in _pulses_permissions or []:
            pulses_permissions_item = NewRoleDataAttributesPulsesPermissionsItem(pulses_permissions_item_data)
        ...
        for retrospective_permissions_item_data in _retrospective_permissions or []:
            retrospective_permissions_item = NewRoleDataAttributesRetrospectivePermissionsItem(
        ...
        for roles_permissions_item_data in _roles_permissions or []:
            roles_permissions_item = NewRoleDataAttributesRolesPermissionsItem(roles_permissions_item_data)
        ...
        for secrets_permissions_item_data in _secrets_permissions or []:
            secrets_permissions_item = NewRoleDataAttributesSecretsPermissionsItem(secrets_permissions_item_data)
        ...
        for services_permissions_item_data in _services_permissions or []:
            services_permissions_item = NewRoleDataAttributesServicesPermissionsItem(services_permissions_item_data)
        ...
        for severities_permissions_item_data in _severities_permissions or []:
            severities_permissions_item = NewRoleDataAttributesSeveritiesPermissionsItem(
        ...
        for status_pages_permissions_item_data in _status_pages_permissions or []:
            status_pages_permissions_item = NewRoleDataAttributesStatusPagesPermissionsItem(
        ...
        for webhooks_permissions_item_data in _webhooks_permissions or []:
            webhooks_permissions_item = NewRoleDataAttributesWebhooksPermissionsItem(webhooks_permissions_item_data)
        ...
        for workflows_permissions_item_data in _workflows_permissions or []:
            workflows_permissions_item = NewRoleDataAttributesWorkflowsPermissionsItem(workflows_permissions_item_data)
