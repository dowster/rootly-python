...
class UpdateAlertGroupDataAttributesTargetsItem:
    """
    Attributes:
        target_type (Union[Unset, UpdateAlertGroupDataAttributesTargetsItemTargetType]): The type of the target.
        target_id (Union[Unset, UUID]): id for the Group, Service or EscalationPolicy
    """

    target_type: Union[Unset, UpdateAlertGroupDataAttributesTargetsItemTargetType] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        target_type: Union[Unset, UpdateAlertGroupDataAttributesTargetsItemTargetType]
        if isinstance(_target_type, Unset):
            target_type = UNSET
        else:
            target_type = UpdateAlertGroupDataAttributesTargetsItemTargetType(_target_type)
        ...
        update_alert_group_data_attributes_targets_item.additional_properties = d
