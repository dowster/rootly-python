...
@_attrs_define
class EscalationPolicyLevelNotificationTargetParamsItemType0:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        type_ = EscalationPolicyLevelNotificationTargetParamsItemType0Type(d.pop("type"))
        ...
        if isinstance(_team_members, Unset):
            ...
            team_members = EscalationPolicyLevelNotificationTargetParamsItemType0TeamMembers(_team_members)

        escalation_policy_level_notification_target_params_item_type_0 = cls(
            id=id,
            type_=type_,
            team_members=team_members,
        )

        escalation_policy_level_notification_target_params_item_type_0.additional_properties = d
        return escalation_policy_level_notification_target_params_item_type_0
