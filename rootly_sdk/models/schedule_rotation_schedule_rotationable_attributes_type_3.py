...
class ScheduleRotationScheduleRotationableAttributesType3:
    ...
    Attributes:
        ...
        shift_length_unit (Union[Unset, ScheduleRotationScheduleRotationableAttributesType3ShiftLengthUnit]): Shift
            length unit for custom rotation
    """

    shift_length: int
    handoff_time: str
    shift_length_unit: Union[Unset, ScheduleRotationScheduleRotationableAttributesType3ShiftLengthUnit] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        shift_length_unit: Union[Unset, ScheduleRotationScheduleRotationableAttributesType3ShiftLengthUnit]
        if isinstance(_shift_length_unit, Unset):
            shift_length_unit = UNSET
        else:
            shift_length_unit = ScheduleRotationScheduleRotationableAttributesType3ShiftLengthUnit(_shift_length_unit)
