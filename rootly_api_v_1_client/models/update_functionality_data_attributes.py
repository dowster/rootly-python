...
if TYPE_CHECKING:
    ...
    from ..models.update_functionality_data_attributes_slack_channels_type_0_item import (
        UpdateFunctionalityDataAttributesSlackChannelsType0Item,
    )


T = TypeVar("T", bound="UpdateFunctionalityDataAttributes")


@_attrs_define
class UpdateFunctionalityDataAttributes:
    """
    Attributes:
        name (Union[Unset, str]): The name of the functionality
        ...
        slack_channels (Union[None, Unset, list['UpdateFunctionalityDataAttributesSlackChannelsType0Item']]): Slack
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        def _parse_slack_channels(
            data: object,
        ) -> Union[None, Unset, list["UpdateFunctionalityDataAttributesSlackChannelsType0Item"]]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for slack_channels_type_0_item_data in _slack_channels_type_0:
                    slack_channels_type_0_item = UpdateFunctionalityDataAttributesSlackChannelsType0Item.from_dict(
                ...
                pass
            return cast(Union[None, Unset, list["UpdateFunctionalityDataAttributesSlackChannelsType0Item"]], data)

        slack_channels = _parse_slack_channels(d.pop("slack_channels", UNSET))

        def _parse_slack_aliases(
            data: object,
        ) -> Union[None, Unset, list["UpdateFunctionalityDataAttributesSlackAliasesType0Item"]]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for slack_aliases_type_0_item_data in _slack_aliases_type_0:
                    slack_aliases_type_0_item = UpdateFunctionalityDataAttributesSlackAliasesType0Item.from_dict(
                ...
                pass
            return cast(Union[None, Unset, list["UpdateFunctionalityDataAttributesSlackAliasesType0Item"]], data)
