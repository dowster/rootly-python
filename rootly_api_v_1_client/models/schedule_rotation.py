...
class ScheduleRotation:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        schedule_rotationable_type = ScheduleRotationScheduleRotationableType(d.pop("schedule_rotationable_type"))
        ...
        for active_days_item_data in _active_days or []:
            active_days_item = ScheduleRotationActiveDaysItem(active_days_item_data)
