...
if TYPE_CHECKING:
    from ..models.update_alerts_source_data_attributes_sourceable_attributes_field_mappings_attributes_item import (
        UpdateAlertsSourceDataAttributesSourceableAttributesFieldMappingsAttributesItem,
    )


T = TypeVar("T", bound="UpdateAlertsSourceDataAttributesSourceableAttributes")


@_attrs_define
class UpdateAlertsSourceDataAttributesSourceableAttributes:
    ...
    Attributes:
        ...
        field_mappings_attributes (Union[Unset,
            list['UpdateAlertsSourceDataAttributesSourceableAttributesFieldMappingsAttributesItem']]): Specify rules to auto
            resolve alerts
    """
    ...
    field_mappings_attributes: Union[
        Unset, list["UpdateAlertsSourceDataAttributesSourceableAttributesFieldMappingsAttributesItem"]
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for field_mappings_attributes_item_data in _field_mappings_attributes or []:
            field_mappings_attributes_item = (
                UpdateAlertsSourceDataAttributesSourceableAttributesFieldMappingsAttributesItem.from_dict(
        ...
        update_alerts_source_data_attributes_sourceable_attributes = cls(
            auto_resolve=auto_resolve,
            resolve_state=resolve_state,
            field_mappings_attributes=field_mappings_attributes,
        )

        update_alerts_source_data_attributes_sourceable_attributes.additional_properties = d
        return update_alerts_source_data_attributes_sourceable_attributes
