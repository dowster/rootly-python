...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = LiveCallRouterResponse.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    """Retrieves a live_call_router

     Retrieves a specific live_call_router by id
